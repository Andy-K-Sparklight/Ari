...
#ifndef INCLUDE_ALICORN_CH_UUID
#define INCLUDE_ALICORN_CH_UUID
#endif
#ifndef NOMINMAX
#define NOMINMAX
#endif
...
// --------------------------------------------------------------------------------------------------------------------------
// time_low	                  unsigned long	   0 - 3	   The low
// field of the timestamp. time_mid	                  unsigned short
// 4 - 5	   The middle field of the timestamp. time_hi_and_version
// unsigned short	   6 - 7	   The high field of the timestamp
// multiplexed with the version number. clock_seq_hi_and_reserved
// unsigned small	   8	      The high field of the clock sequence
// multiplexed with the variant. clock_seq_low	            unsigned small
// 9	      The low field of the clock sequence. node character 10 - 15
...
public:
  ...
  constexpr
  uuid(std::array<value_type, 16> const &arr) noexcept : data{ arr }
  {
  }
